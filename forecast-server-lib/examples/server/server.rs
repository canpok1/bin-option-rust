//! Main library entry point for forecast_server_lib implementation.
...
use forecast_server_lib::models;
...
pub async fn create(addr: &str, https: bool) {
    ...
    let mut service =
        forecast_server_lib::server::context::MakeAddContext::<_, EmptyContext>::new(
            service
        );
